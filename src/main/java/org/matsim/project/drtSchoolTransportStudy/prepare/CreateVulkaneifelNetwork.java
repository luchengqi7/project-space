...
public class CreateVulkaneifelNetwork implements MATSimAppCommand {
    private static final Logger log = LogManager.getLogger(CreateVulkaneifelNetwork.class);
    ...
    public static void main(String[] args) {
        new CreateVulkaneifelNetwork().execute(args);
    }
