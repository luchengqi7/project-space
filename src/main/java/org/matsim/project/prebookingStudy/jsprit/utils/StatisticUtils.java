...
public class StatisticUtils {
    ...
    public void printVerboseNetworkBased(VehicleRoutingProblem problem, VehicleRoutingProblemSolution solution) {
    ...
    public void writeNetworkBased(String matsimConfig, String tripsFilename) {
